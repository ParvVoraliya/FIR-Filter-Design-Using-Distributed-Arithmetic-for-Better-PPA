...
Compared to a conventional general FIR implementation, the proposed DA architecture reduced LUT utilization from **496 to 179 LUTs**, achieving approximately **64% lower area utilization**.

### Power Analysis

| Parameter           | Optimized DA FIR |
| ------------------- | ---------------: |
| Dynamic Power       |      **7.316 W** |
| Static Power        |      **0.158 W** |
| Total On-Chip Power |      **7.474 W** |

Compared to a conventional FIR implementation, the proposed DA architecture reduced total on-chip power from approximately **40.13 W** to **7.47 W**, corresponding to an **81% reduction in power consumption**.
